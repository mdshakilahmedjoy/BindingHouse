   ...
   <div class="content-page">
        <div class="content">
            <div class="container">
                ...
                @php
        			$today_invest = DB::table('invests')->where('date','Like',"%$data%")->sum('amount');
                @endphp
                    ...
                    <div class="col-md-10">
                        <div class="panel panel-primary">
                            <div class="panel-heading" style="padding-left:50px;">
                                <h3 class="panel-title">Today Invest ({{ $data }})</h3>
                            </div>
                            
                            <div>
                                <h3 style="color: red; font-size: 22px;" align="center" >Total Invest : {{$today_invest}} Taka. </h3><br>

                                <form role="form" action="{{ url('/today-invest')}}" method="post">
                                @csrf 
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ URL::to('/edit-today-invest/'.$row->id) }}" class="btn btn-sn btn-info" id="edit">Edit</a>
