                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="panel panel-primary">
                            <div class="panel-heading" style="padding-left:50px;"><h3 class="panel-title">Update Yearly Invest ({{ $yearly->date }})</h3></div>
                            <div class="panel-body">
                                <form role="form" action="{{ url('/update-yearly-invest/'.$yearly->id )}}" method="post">
                                    @csrf
