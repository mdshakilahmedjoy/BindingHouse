        ...
        <div class="content">
            <div class="container">
                ...
                @php
                    ...
                    $tatal_monthly_expense = ($totalexpense + $totalsalary + $totaladvanced);
                @endphp
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="panel panel-primary">
                            ...
                            <div>
                                <h3 style="color: red; font-size: 22px;" align="center" >Total Expense : {{$tatal_monthly_expense}} Taka. </h3><br>

                                <form role="form" action="{{ url('/monthly-expense')}}" method="post">
                                @csrf 
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ URL::to('/edit-monthly-expense/'.$row->id) }}" class="btn btn-sn btn-info" id="edit">Edit</a>
