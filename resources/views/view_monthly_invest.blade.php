   ...
   <div class="content-page">
        <div class="content">
            <div class="container">
                ...
                @php
                    $mothly_invest = DB::table('invests')->where('date','Like',"%$data%")->sum('amount');
                @endphp
                    ...
                    <div class="col-md-10">
                        <div class="panel panel-primary">
                            <div class="panel-heading" style="padding-left:50px;">
                                <h3 class="panel-title">Monthly Invest ({{ $data }})</h3>
                            </div>
                            
                            <div>
                                <h3 style="color: red; font-size: 22px;" align="center" >Total Invest : {{$mothly_invest}} Taka. </h3><br>

                                <form role="form" action="{{ url('/monthly-invest')}}" method="post">
                                @csrf 
                                    <h4 class="text-success" align="center">
                                        <div class="form-group" style="margin-left: 100px;">
                                            <input type="month" name="searchdate" style="width:165px;" required> 
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ URL::to('/edit-monthly-invest/'.$row->id) }}" class="btn btn-sn btn-info" id="edit">Edit</a>
